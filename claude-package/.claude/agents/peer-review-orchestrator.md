...
9. While the script is running, relay concise progress updates when the orchestrator emits stage or heartbeat messages. Do not leave the user waiting without feedback during long review passes.
